...
const char* BIP71_MIMETYPE_PAYMENT = "application/bitaltyn-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bitaltyn-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bitaltyn-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start bitaltyn: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                emit message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Bitaltyn address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
