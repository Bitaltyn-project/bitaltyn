...
public:
    CMainParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10 * 30; // 5 minutes
        ...
        // Bitaltyn: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        // Bitaltyn: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // Bitaltyn: v2 enforced using Bitcoin's supermajority rule
