...
#if defined(NDEBUG)
# error "Bitaltyn cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bitaltyn Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("bitaltyn-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Bitaltyn: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Bitaltyn: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
