...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bitaltyn Core bitaltyn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitaltyn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitaltyn transaction") + "\n" +
              "  bitaltyn-tx [options] -create [commands]   " + _("Create hex-encoded bitaltyn transaction") + "\n" +
              "\n";
